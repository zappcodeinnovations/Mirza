      ...
      children: [
        Positioned(
          ...
          child: AnimatedContainer(
            ...
            width: _isChatOpen ? MediaQuery.sizeOf(context).width - 32 : 60,
            height: _isChatOpen ? MediaQuery.sizeOf(context).height * 0.60 : 60,
        ...
        if (_isChatOpen)
          Positioned(
            right: 24,
            bottom: MediaQuery.sizeOf(context).height * 0.60 + 28,
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 2),
                Text(
                  'Ask about stock, returns, and SKU data',
                  maxLines: 1,
      ...
      children: [
        if (!msg.isUser) ...[
          Container(
            ...
            child: const Icon(AppIcons.robot, color: Color.fromARGB(255, 238, 242, 246), size: 18),
          ),
          const SizedBox(width: 10),
        ],
        Flexible(
      ...
      children: [
        Row(
          ...
          children: [
            Text(
              label,
              style: const TextStyle(color: Color(0xFF64756D), fontSize: 11),
            ),
            Text(
              '$val un',
              style: const TextStyle(
